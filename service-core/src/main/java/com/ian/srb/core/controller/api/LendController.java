...
public class LendController {
    ...
    public Rs list() {
        ...
        return Rs.success().data("lendList", lendList);
    }
    ...
    public Rs show(
        ...
        return Rs.success().data("lendDetail", lendDetail);
    }

    @ApiOperation("计算投资收益")
    @GetMapping("/getInterestCount/{invest}/{yearRate}/{totalmonth}/{returnMethod}")
    public Rs getInterestCount(
        ...
        return Rs.success().data("interestCount", interestCount);
    }
}
