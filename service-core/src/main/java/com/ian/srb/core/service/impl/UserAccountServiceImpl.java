...
import com.ian.srb.core.service.UserAccountService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.ian.srb.core.service.UserBindService;
import com.ian.srb.core.utils.LendNoUtils;
...
public class UserAccountServiceImpl extends ServiceImpl<UserAccountMapper, UserAccount> implements UserAccountService {
    ...
    @Override
    public String submit(BigDecimal chargeAmt, Long userId) {
        //判断用户是否绑定
    ...
    public String notify(Map<String, Object> paramMap) {
        ...
        //首先进行流水号的判断 agent_bill_no 和trans_flow的trans_no
        ...
        //插入trans_flow的流水记录，通过parmMap的参数，装进TransFlowBO，再通过方法，装进装进TransFlow后更新
